package com.thuan.fitnessapp.data;
...
import com.thuan.fitnessapp.BaseActivity;
import com.thuan.fitnessapp.FAQActivity;
import com.thuan.fitnessapp.R;
import com.thuan.fitnessapp.data.models.QA;
...
public class QaAdapter extends RecyclerView.Adapter<QaAdapter.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final QaAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
